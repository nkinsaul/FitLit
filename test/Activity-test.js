...
describe("Activity", () => {
    ...
    beforeEach(function() {
        ...
        activity2 = new Activity(1, "2019/06/16", activityData1);
    });
    ...
    it("Should have a method to find its own activity object using userID and date arguments as well as activity data passed in as parameters", () => {
        let foundActivityObject = activity1.getActivityObject(1, "2019/06/15", activityData1);
        expect(foundActivityObject).to.be.equal(activity1.activityObj);
        expect(foundActivityObject.numSteps).to.be.equal(3577);
    });
